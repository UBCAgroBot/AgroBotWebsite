...
function SubteamBox({ emoji, title, bulletPoints, bg, overlayFn }) {
  useEffect(() => {
	...
	return (
		<div className="w-[300px] mb-4 lg:mb-0 lg:w-[312px] h-[500px] bg-[#2E1B0F] rounded-[46px] flex flex-col items-center pt-[10px] text-white">
...
function Recruitment() {
	...
	return (
		<div className="mt-standard pb-32 w-[300px] lg:w-[1000px] mx-auto">
			...
			<h1 className="text-mobile-header lg:text-header font-bold">Join the<br />Agrobot team!</h1>
			<Timeline />
			<h2 className="text-[32px] text-center lg:text-left lg:text-body font-semibold my-12 mt-20">AgroBot Subteams:</h2>
			...
			<h2 className="text-[32px] text-center lg:text-left font-semibold my-12 mt-20">AgroPonics Subteams:</h2>
			<div className="flex flex-col lg:flex-row lg:justify-between">
				<SubteamBox overlayFn={setShowSubteam} bg="#91D0F2" emoji='🤖' title='Applied AI' bulletPoints={["develop AI models to detect weeds"]} />
				<SubteamBox overlayFn={setShowSubteam} bg="#1F5200" emoji='🏎️' title='Chassis' bulletPoints={["Build the agrobot chassis"]} />
				<SubteamBox overlayFn={setShowSubteam} bg="#91D0F2" emoji='🔋' title='Powertrain' bulletPoints={["Build the agrobot powertrain"]} />
			</div>
			<h2 className="text-[32px] text-center lg:text-left font-semibold my-12 mt-20">AgroPicker Subteams:</h2>
			<div className="flex flex-col lg:flex-row lg:justify-between">
				<SubteamBox overlayFn={setShowSubteam} bg="#91D0F2" emoji='🤖' title='Applied AI' bulletPoints={["develop AI models to detect weeds"]} />
				<SubteamBox overlayFn={setShowSubteam} bg="#1F5200" emoji='🏎️' title='Chassis' bulletPoints={["Build the agrobot chassis"]} />
				<SubteamBox overlayFn={setShowSubteam} bg="#91D0F2" emoji='🔋' title='Powertrain' bulletPoints={["Build the agrobot powertrain"]} />
			</div>
			<h2 className="text-[32px] text-center lg:text-left font-semibold my-12 mt-20">Admin Subteams:</h2>
			<div className="flex flex-col lg:flex-row lg:justify-between">
