...
function WhoWeAre() {
	...
	return (
		<div className="my-32 flex w-full max-w-full items-stretch overflow-hidden lg:my-48">
			...
			<div className="relative mx-auto w-[280px] bg-[#CDFF70] text-[20px] lg:w-[1000px] lg:text-[24px]">
				<div className='lg:w-[100%]'>
					<h3 className="pb-4 text-mobile-header font-semibold lg:text-header">What makes a good AgroBotee?</h3>
					<p className="mb-6">
					...
					<h4 className="my-2 font-semibold">Here's what makes a good AgroBotee:</h4>
					<ul className="ml-12 list-disc text-[20px]">
					...
					<h3 className="pb-4 pt-8 text-mobile-header font-semibold lg:text-header">Our Values:</h3>
					<ol className="ml-12 list-decimal text-[20px]">
