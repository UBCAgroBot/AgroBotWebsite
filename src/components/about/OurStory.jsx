...
function OurStory() {
	...
	return (
		<div className="w-[300px] pt-32 lg:pt-48 lg:w-full lg:pl-32 lg:min-h-[948px] mx-auto bg-[#CDFF70]">
			<div className='lg:w-[50%]'>
				<h3 className="text-[40px] lg:text-[48px] font-bold pb-8">The story of<br /> UBC Agrobot</h3>
