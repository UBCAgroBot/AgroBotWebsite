  ...
  return (
    <div className="bg-white w-full m-[1%] rounded-[14px] text-center flex flex-col">
      <div className="flex-grow">
        ...
        <h5 className="p-2 font-bold text-[24px]" style={{ color: tierColor }}>
          {price}
        </h5>
        <ul className="p-5">
      ...
      <a
        href="https://donate.support.ubc.ca/page/20924/donate/1?transaction.dirgift=AgroBot%20G2551"
        target="_blank"
        className="p-4 m-4 border-2 rounded-[14px] border-[#8cbc24] text-[#8cbc24] font-bold"
        rel="noreferrer"
      >
        Sponsor Us
      </a>
