				...
				<div className="w-full h-full text-[#2E1B0F] flex flex-col justify-center">
					...
					<div>
						<p className="p-4 bg-[#ffffffe8] rounded-[36px] text-[20px] mb-7 drop-shadow-xl">
							...
							budget of $773 million, UBC funds over 10,000 projects a year.[4]
						</p>
					</div>
					<div>
						<a href="#" className="p-3 px-8 text-[24px] bg-[#2E1B0F] text-white font-bold rounded-[36px] drop-shadow-xl">LEARN MORE <FaChevronRight className="inline mb-1" /> </a>
					</div>
				</div>
			</animated.div>
			<div className="w-[47.5%] h-[50vh] bg-[#2E1B0F] relative top-[100vh] rounded-lg">CAD MODEL</div>
		</div>
	)
}
