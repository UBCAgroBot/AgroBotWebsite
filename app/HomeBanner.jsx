    ...
    return (
        <div className="h-[100vh] w-full bg-[#91D0F2] flex flex-col-reverse md:flex-row justify-center items-center relative z-[0] pt-16">
            ...
            <div className="md:w-[50%] flex flex-col items-center justify-center z-[2]">
                <h1 className="h-[220px] md:h-[300px] text-body lg:text-header text-[#3A3A3A] font-bold text-center uppercase leading-[1.15]">
                    {titleText[0]} <br />
            ...
            <div className='h-[40%] md:h-auto md:w-[50%] z-[2]'>
                <img className="h-full md:h-auto md:w-[547px]" alt="a farm being manned by cute robots" src='/img/HomeFarm.png' />
            </div>
        </div>
    );
}
