...
function Timeline() {
    ...
    function GetDateOffset(start_day: Date, end_day: Date): number {
        ...
        const totalDuration = (end_day.getTime() - start_day.getTime()) / (1000 * 60 * 60 * 24);

        // Calculate elapsed time in days
        const elapsedTime = (today.getTime() - start_day.getTime()) / (1000 * 60 * 60 * 24);
    ...
    const days_to_apply = Math.ceil((end_day.getTime() - today.getTime()) / (1000 * 3600 * 24))
