	...
	return (
		<div className="flex mt-32 lg:mt-48 items-stretch max-w-full overflow-x-hidden">
 			<div className="hidden lg:block flex-grow relative">
 				<img src='/img/gaetano-cessati.jpg' alt="green pasture" className="absolute top-[-0px] right-12 h-96 object-cover" />
			</div>
			...
			<div className="hidden lg:block flex-grow relative">
				<img src='/img/daniel-faziojpg.jpg' className="absolute bottom-0 left-12 h-96 object-cover" />
			</div>
		</div>
	)
}
