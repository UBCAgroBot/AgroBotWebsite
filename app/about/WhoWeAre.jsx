	...
	return (
		<div className="flex my-32 lg:my-48 items-stretch w-full max-w-full overflow-hidden">
			<div className="hidden lg:block flex-grow relative">
				<img src='/img/cameron-witney.jpg' className="absolute bottom-[0px] right-[12px] h-96 object-cover"/>
			</div>
			...
			<div className="hidden lg:block flex-grow relative">
				<img src='/img/ryan-searle.jpg' className=" absolute left-12 top-[-0px] h-[420px] object-cover"/>
			</div>
		</div>
	)
}
